...
app.listen(3000);//que el servidor guardado en app, escuche en el puerto 3000
console.log('Server on port 3000');//una vez inicia el servidor muestra mensaje por consola
